...
/**
 * Implements the IDepartmentRepository interface using a JSON file for persistence. This class
 * manages the serialization and deserialization of Department objects.
 */
public class DepartmentRepository implements IDepartmentRepository {
  ...
  public void save(Department department) throws DuplicateEntityException {
    if (departments.values().stream()
      ...
      throw new DuplicateEntityException(
          "Error: Department with name '" + department.getName() + "' already exists.");
    }
  ...
  /**
   * Deserializes department data from the JSON file into the in-memory map. If the file does not
